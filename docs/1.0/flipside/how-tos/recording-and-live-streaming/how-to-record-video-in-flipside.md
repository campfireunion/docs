...
Here's how to record video in Flipside.
...
After completing the one-time steps above, here are the steps you can use to record video from Flipside.

> **Note:** If you're using the desktop version of Flipside, you can skip to **Step 4** and capture Flipside directly in OBS, unless you want to capture on a separate machine than the one you're using for VR.
...
**Step 5.** When you're done recording, click **Stop Recording** in OBS and click **Stop Cast** on the camera switcher in Flipside to stop broadcasting to Flipside Broadcaster.

---

**Next:** [[:How to live stream from Flipside]]
